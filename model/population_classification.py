...
train_generator = train_datagen.flow_from_directory(# 타깃 디렉터리
                                                    train_dir,
...
def population_model_classification_ver1():
    # make model version 1 : CNN
...
model = population_model_classification_ver1()
